...
public class SJF_Scheduler {
    ...
    private static List<Cloudlet> createCloudlet(int userId, int cloudlets, int idShift) {
        ...
        for (int i = 0; i < cloudlets; i++) {
            int dcId = (int) (Math.random() * SimulationConstants.DATACENTER_COUNT);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            datacenter = new Datacenter[SimulationConstants.DATACENTER_COUNT];
            for (int i = 0; i < SimulationConstants.DATACENTER_COUNT; i++) {
            ...
            vmList = createVM(brokerId, SimulationConstants.DATACENTER_COUNT);
            cloudletList = createCloudlet(brokerId, SimulationConstants.CLOUDLET_COUNT, 0);
    ...
    private static double calcMakespan(List<Cloudlet> list) {
        double makespan = 0;
        double[] dcWorkingTime = new double[SimulationConstants.DATACENTER_COUNT];

        for (int i = 0; i < SimulationConstants.CLOUDLET_COUNT; i++) {
            int dcId = list.get(i).getVmId() % SimulationConstants.DATACENTER_COUNT;
