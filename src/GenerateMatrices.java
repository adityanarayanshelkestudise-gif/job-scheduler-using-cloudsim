...
public class GenerateMatrices {
    ...
    public GenerateMatrices() {
        commMatrix = new double[SimulationConstants.CLOUDLET_COUNT][SimulationConstants.DATACENTER_COUNT];
        execMatrix = new double[SimulationConstants.CLOUDLET_COUNT][SimulationConstants.DATACENTER_COUNT];
        try {
